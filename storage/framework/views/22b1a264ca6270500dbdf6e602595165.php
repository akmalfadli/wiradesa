...
<script>
    let dataStats = [];
    let chart = null;
    let currentType = '<?php echo e($default_chart_type ?? 'pie'); ?>';
    let is3DEnabled = <?php echo e(setting('statistik_chart_3d') ? 'true' : 'false'); ?>;
    ...
    function createChart() {
        ...
        const commonOptions = {
            ...
            subtitle: {
                text: 'Data Statistik <?php echo e($selected_tahun ?? "Terkini"); ?>',
                style: {
                    fontSize: '14px',
                    color: '#6b7280'
                }
    ...
    $(function() {
        ...
        const defaultChartType = '<?php echo e($default_chart_type ?? 'pie'); ?>';
    ...
    $(document).ready(function() {
        if ($('#peserta_program').length > 0) {
            ...
            let pesertaDatatable = $('#peserta_program').DataTable({
                ...
                order: [1, 'asc'],
                language: {
                    url: "<?php echo e(asset('assets/bootstrap/js/dataTables.indonesian.lang')); ?>"
                },
