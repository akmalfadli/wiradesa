...
<h1 class="text-h2"><?php echo e($judul); ?></h1>
...
<div class="flex justify-between items-center space-x-1 py-5">
    <h2 class="text-h4">Grafik <?php echo e($heading); ?></h2>
    <div class="text-right btn-switch-chart space-x-2 text-sm space-y-2 md:space-y-0">
        ...
        <a href="<?php echo e(ci_route("data-statistik.{$slug_aktif}.cetak.unduh")); ?>?tahun=<?php echo e($selected_tahun); ?>" class="btn btn-accent btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Unduh Laporan" target="_blank">
            <i class="fa fa-print "></i> Unduh
        </a>
    </div>
</div>
<div id="statistics"></div>
<h2 class="text-h4">Tabel <?php echo e($heading); ?></h2>
<div class="content py-3">
    ...
    <?php if(setting('daftar_penerima_bantuan') && $bantuan): ?>
        ...
        <h2 class="text-h4">Daftar <?php echo e($heading); ?></h2>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /Users/akmalfadli/Developer/desa-digital/wiradesa//storage/app/themes/perwira/resources/views/partials/statistik/default.blade.php ENDPATH**/ ?>