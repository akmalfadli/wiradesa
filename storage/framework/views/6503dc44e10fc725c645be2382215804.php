...
<?php $__env->startSection('content'); ?>
    <nav role="navigation" aria-label="navigation" class="breadcrumb">
        <ol>
            <li><a href="<?php echo e(site_url('/')); ?>">Beranda</a></li>
            <li aria-current="page">Status IDM</li>
        </ol>
    </nav>

    <h1 class="text-h2">
        Status Indeks Desa Membangun (IDM) <?php echo e($tahun); ?>
                ...
                <div class="table-responsive">
                    <table class="overflow-auto table-striped table text-sm capitalize">
                        <tbody>
                            ...
                            <tr>
                                <th class="horizontal"><?php echo e(strtoupper(setting('sebutan_kecamatan'))); ?></th>
                                <td id="nama-kecamatan"></td>
                            </tr>
                            <tr>
                                <th class="horizontal"><?php echo e(strtoupper(setting('sebutan_desa'))); ?></th>
                                <td id="nama-desa"></td>
                            </tr>
...
<?php $__env->startPush('scripts'); ?>
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var route = '<?php echo e(route('api.idm', $tahun)); ?>';
...
<?php echo $__env->make('theme::layouts.full-content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/akmalfadli/Developer/desa-digital/wiradesa//storage/app/themes/perwira/resources/views/partials/idm/index.blade.php ENDPATH**/ ?>