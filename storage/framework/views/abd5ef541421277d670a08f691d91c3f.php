<?php $__env->startSection('content'); ?>
    <div class="single_page_area">
        <h2 class="post_titile"><?php echo e($heading); ?></h2>
        <div class="box-body">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            function loadWilayah() {
                ...
                var apiWilayah = '<?php echo e(route('api.wilayah.administratif')); ?>';
...
<?php echo $__env->make('theme::layouts.right-sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/akmalfadli/Developer/desa-digital/wiradesa//storage/app/themes/natra/resources/views/partials/wilayah/index.blade.php ENDPATH**/ ?>