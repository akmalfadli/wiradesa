...
<nav class="bg-primary-100 text-white hidden lg:block" role="navigation">
    <ul>
        <li class="inline-block">
            <a href="<?php echo e(site_url('/')); ?>" class="inline-block py-3 px-4 hover:bg-primary-200"><i class="fa fa-home"></i></a>
        </li>
        <?php if(menu_tema()): ?>
            <?php $__currentLoopData = menu_tema(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <li class="inline-block relative" <?php if($has_dropdown): ?> x-data="{dropdown: false}" <?php endif; ?>>
                    ...
                    <a href="<?php echo e($menu_link); ?>" class="p-3 inline-block hover:bg-primary-200" @mouseover="dropdown = true" @mouseleave="dropdown = false" @click="dropdown = !dropdown" <?php if($has_dropdown): ?> aria-expanded="false"
...
<?php /**PATH /Users/akmalfadli/Developer/desa-digital/wiradesa//storage/app/themes/esensiA/resources/views/commons/main_menu.blade.php ENDPATH**/ ?>