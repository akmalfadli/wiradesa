<?php $__env->startSection('layout'); ?>
    <div class="container mx-auto lg:px-5 px-3 flex flex-col-reverse lg:flex-row my-5 gap-3 lg:gap-5 justify-between text-gray-600">
        ...
        <main class="lg:w-3/4 w-full space-y-1 bg-white rounded-lg px-4 py-2 lg:py-4 lg:px-5 shadow">
            ...
            <h1 class="text-h2"><?php echo e($heading); ?></h1>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            function loadWilayah() {
                ...
                var routeWilayah = '<?php echo e(route('api.wilayah.administratif')); ?>';
...
<?php echo $__env->make('theme::template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/akmalfadli/Developer/desa-digital/wiradesa//storage/app/themes/perwira/resources/views/partials/wilayah/index.blade.php ENDPATH**/ ?>