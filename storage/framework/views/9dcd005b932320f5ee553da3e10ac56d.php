        ...
        <div class="flex gap-3 justify-center mb-3">
            <?php $__currentLoopData = $sosmed; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if(!empty($data['link'])): ?>
                    <a href="<?php echo e($data['link']); ?>" class="bg-green-600 p-3 rounded-full hover:bg-green-500 transition-colors">
...
<footer class="bg-green-700 text-white py-6 md:py-8 pb-20 md:pb-8">
    <div class="max-w-6xl mx-auto px-4 md:px-6 lg:px-8">
            ...
            <div class="text-center">
                <div class="flex items-center justify-center gap-3 mb-4">
                    <div class="w-12 h-12 flex items-center justify-center">
                        <img src="<?php echo e(gambar_desa($desa['logo'])); ?>" alt="Logo <?php echo e(ucfirst(setting('sebutan_desa')) . ' ' . ucwords($desa['nama_desa'])); ?>" class="h-10 w-auto">
                    </div>
                    <div>
                        <p class="text-base font-semibold"><?php echo e(ucfirst(setting('sebutan_desa'))); ?> <?php echo e(ucwords($desa['nama_desa'])); ?></p>
                    </div>
                </div>
                <div class="text-sm space-y-1">
                    ...
                    <p class="mt-3">Email: <?php echo e($desa['email_desa']); ?></p>
                </div>
            </div>
        ...
        <div class="hidden md:flex md:flex-row">
            <div class="mb-6 md:mb-0 md:w-1/3">
                ...
                <div class="text-sm space-y-1">
                    ...
                    <p>Email: <?php echo e($desa['email_desa']); ?></p>
                </div>
            </div>
        ...
        <div class="border-t border-green-600 mt-6 md:mt-8 pt-4 text-center text-xs">
            <p class="mb-2">Hak cipta situs &copy; <?php echo e(date('Y')); ?> - <?php echo e(ucfirst(setting('sebutan_desa'))); ?> <?php echo e(ucwords($desa['nama_desa'])); ?></p>
            <p>
                <a href="https://akmalfadli.github.io" class="underline decoration-pink-500 underline-offset-1 decoration-2 hover:text-pink-200 transition-colors" target="_blank" rel="noopener">Tema Perwira <?php echo e($themeVersion); ?></a> -
                <a href="https://opensid.my.id" class="underline decoration-green-500 underline-offset-1 decoration-2 hover:text-green-200 transition-colors" target="_blank" rel="noopener">OpenSID <?php echo e(ambilVersi()); ?></a> 
            </p>
        </div>
    </div>
</footer>
