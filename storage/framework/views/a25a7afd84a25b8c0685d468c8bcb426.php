                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $alias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $isian): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="bold" data-index="<?php echo e($isian->id); ?>">
                            <td><input type="text" class="form-control" name="judul_kodeisian[]" readonly value="<?php echo e($isian->judul); ?>" maxlength="20" /></td>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /Users/akmalfadli/Developer/desa-digital/wiradesa/resources/views/admin/pengaturan_surat/partials/pengaturan_kodeisian.blade.php ENDPATH**/ ?>