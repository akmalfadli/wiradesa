...
<div class="border border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition-shadow h-100 flex flex-col">
    ...
    <div class="p-4 flex flex-col flex-grow">
        ...
        <span class="text-xs text-gray-500"> <?php echo e($post['owner']); ?></span>
    </div>
</div><?php /**PATH /Users/akmalfadli/Developer/desa-digital/wiradesa//storage/app/themes/perwira/resources/views/partials/artikel/list.blade.php ENDPATH**/ ?>