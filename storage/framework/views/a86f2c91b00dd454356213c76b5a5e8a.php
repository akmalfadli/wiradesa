...
<?php $__env->startSection('content'); ?>
    <div class="box-body">
        <div class="single_page_area">
            <h2 class="post_titile"><?php echo e($judul); ?></h2>
        </div>
                ...
                <div class="col-sm-3">
                    <select class="form-control input-sm" id="tahun" name="tahun">
                        ...
                        <?php $__currentLoopData = $list_tahun; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item_tahun): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option <?= ($item_tahun == ($selected_tahun ?? null)) ? 'selected' : ''; ?> value="<?php echo e($item_tahun); ?>">
                                <?php echo e($item_tahun); ?></option>
        ...
        <div class="box-stats d-flex justify-content-end">
            <div class="btn-group-xs">
                <a class="btn <?php echo e(($default_chart_type ?? 'pie') == 'pie' ? 'btn-primary' : 'btn-default'); ?> btn-xs" onclick="switchType(this);">Bar Graph</a>
                <a class="btn <?php echo e(($default_chart_type ?? 'pie') == 'column' ? 'btn-primary' : 'btn-default'); ?> btn-xs" onclick="switchType(this);">Pie Cart</a>
                <a href="<?php echo e(ci_route(" data-statistik.{$slug_aktif}.cetak.cetak")); ?>?tahun=<?php echo e($selected_tahun); ?>" class="btn btn-primary btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Cetak Laporan" target="_blank">
                    <i class="fa fa-print "></i> Cetak
                </a>
                <a href="<?php echo e(ci_route(" data-statistik.{$slug_aktif}.cetak.unduh")); ?>?tahun=<?php echo e($selected_tahun); ?>" class="btn btn-success btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Unduh Laporan" target="_blank">
    ...
    <div class="box-header with-border">
        <h2 class="post_titile">Tabel <?php echo e($heading); ?></h2>
    </div>
    <div class="box-body">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-info">
                        <div class="box-header with-border" style="margin-bottom: 15px;">
                            <h2 class="post_titile">Daftar <?php echo e($heading); ?></h2>
                        </div>
                        <div class="table-responsive">
    ...
    <?php $__env->startPush('scripts'); ?>
        <script type="text/javascript">
            let chart;
            const type = '<?php echo e($default_chart_type ?? 'pie'); ?>';
            const legend = Boolean(<?php echo e((bool) $tipe); ?>);
            let i = 1;
            ...
            $(document).ready(function() {
                if (<?php echo e(setting('statistik_chart_3d')); ?>) {
...
<?php echo $__env->make('theme::layouts.right-sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/akmalfadli/Developer/desa-digital/wiradesa//storage/app/themes/natra/resources/views/partials/statistik/index.blade.php ENDPATH**/ ?>