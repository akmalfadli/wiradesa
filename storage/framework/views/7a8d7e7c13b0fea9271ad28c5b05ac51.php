    ...
    <div class="space-y-4">
        <div class="flex items-center justify-between p-4 bg-gradient-to-r from-primary-50 to-primary-100 rounded-xl">
            ...
            <div class="text-right">
                <p class="text-2xl font-bold text-primary-700"><?php echo e(number_format($statistik_pengunjung['hari_ini'])); ?></p>
                <p class="text-xs text-primary-600"><?php echo e($percentageChange . '%'); ?></p>
            </div>
        </div>
        ...
        <div class="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
            ...
            <div class="text-right">
                <p class="text-2xl font-bold text-gray-700"><?php echo e(number_format($statistik_pengunjung['kemarin']) ?? 0); ?></p>
            </div>
        </div>
        ...
        <div class="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
            ...
            <div class="text-right">
                <p class="text-2xl font-bold text-gray-700"><?php echo e(number_format($statistik_pengunjung['total'])); ?></p>
            </div>
        </div>
    </div>
</div><?php /**PATH /Users/akmalfadli/Developer/desa-digital/wiradesa//storage/app/themes/perwira/resources/views/widgets/statistik_pengunjung.blade.php ENDPATH**/ ?>