...
<?php $__env->startSection('content'); ?>
    ...
    <div class="box box-info">
        <form action="<?php echo e($form_action); ?>" method="POST" enctype="multipart/form-data" id="validasi" class="form-horizontal">
            <div class="box-body">
                <div id="tampil-map">
            ...
            <div class="box-footer">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="required form-control input-sm lat" name="lat" id="lat" value="<?php echo e($wil_ini['lat']); ?>" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label" for="lat">Longitude</label>
                    <div class="col-sm-9">
                        <input type="text" class="required form-control input-sm lng" name="lng" id="lng" value="<?php echo e($wil_ini['lng']); ?>" />
                    </div>
                </div>
...
<?php echo $__env->make('admin.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/akmalfadli/Developer/desa-digital/wiradesa/resources/views/admin/wilayah/maps_kantor.blade.php ENDPATH**/ ?>