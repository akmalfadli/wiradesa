            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input id="nama_kontak" name="nama_kontak" class="form-control input-sm nama required" type="text" placeholder="Nama Perangkat Desa" value="<?php echo e($main['nama_kontak']); ?>" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="hp_kontak">No. HP/WA</label>
                        <div class="col-sm-8">
                            <input id="hp_kontak" name="hp_kontak" class="form-control input-sm telepon required" type="text" placeholder="No. HP Perangkat Desa" value="<?php echo e($main['hp_kontak']); ?>" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="jabatan_kontak">Jabatan</label>
                        <div class="col-sm-8">
                            <input id="jabatan_kontak" name="jabatan_kontak" class="form-control input-sm nama required" type="text" placeholder="Jabatan" value="<?php echo e($main['jabatan_kontak']); ?>" />
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('admin.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/akmalfadli/Developer/desa-digital/wiradesa/resources/views/admin/identitas_desa/form.blade.php ENDPATH**/ ?>