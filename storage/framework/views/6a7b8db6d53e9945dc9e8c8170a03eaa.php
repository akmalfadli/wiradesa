    ...
    <article class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
        ...
        <div class="relative h-48 bg-gradient-to-br from-green-400 to-blue-500 overflow-hidden">
            <?php if(isset($post['gambar']) && $post['gambar']): ?>
                <img src="<?php echo e(AmbilFotoArtikel($post['gambar'], 'sedang')); ?>" 
        ...
        <div class="p-5">
            ...
            <div class="flex items-center text-xs text-gray-500 mb-3">
                ...
                <span><?php echo e(tgl_indo($post['tgl_upload'])); ?></span>
                <?php if(isset($post['owner']) && $post['owner']): ?>
                    <span class="mx-1">•</span>
                    <span><?php echo e($post['owner']); ?></span>
                <?php endif; ?>
            </div>

            <!-- Title -->
            <h3 class="font-bold text-gray-900 mb-3 leading-tight line-clamp-2">
                <a href="<?php echo e(ci_route('artikel.' . $post['id'] . '.' . $post['slug'])); ?>" 
            ...
            <p class="text-sm text-gray-600 mb-4 line-clamp-3 leading-relaxed">
                <?php echo e(strip_tags(potong_teks($post['isi'], 120))); ?>
            ...
            <div class="flex items-center justify-between">
                ...
                <!-- Share Button -->
                <button onclick="shareArticle('<?php echo e($post['judul']); ?>', '<?php echo e(ci_route('artikel.' . $post['id'] . '.' . $post['slug'])); ?>')" 
...
</script><?php /**PATH /Users/akmalfadli/Developer/desa-digital/wiradesa//storage/app/themes/perwira/resources/views/partials/artikel/mobile-card.blade.php ENDPATH**/ ?>