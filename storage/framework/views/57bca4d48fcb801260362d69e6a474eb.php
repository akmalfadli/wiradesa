    ...
    <div class='col-sm-4'>
        <div class='form-group'>
            ...
            <div class="input-group input-group-sm date">
                ...
                <input class="form-control input-sm pull-right tgl_indo" name="tanggalperceraian" type="text" value="<?php echo e($penduduk['tanggalperceraian'] ? date('d-m-Y', strtotime($penduduk['tanggalperceraian'])) : ''); ?>">
            </div>
        </div>
    </div>
    <div class='col-sm-12'>
    ...
    <div id="status_asuransi" class="col-sm-4">
        <div class='form-group'>
            ...
            <select class="form-control input-sm" name="status_asuransi">
                <option value="" <?= ($penduduk['status_asuransi'] == null) ? 'selected' : ''; ?>>Pilih Kepersertaan Asuransi Kesehatan</option>
                <?php $__currentLoopData = \App\Enums\AktifEnum::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($key); ?>" <?= (isset($penduduk['status_asuransi']) && $penduduk['status_asuransi'] == $key) ? 'selected' : ''; ?>><?php echo e(strtoupper($value)); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        </div>
    </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /Users/akmalfadli/Developer/desa-digital/wiradesa/resources/views/admin/penduduk/penduduk_form_isian_bersama.blade.php ENDPATH**/ ?>